                        ...
                        <div class="card">
                            ...
                            <h4 class="card-title">Buku Kas</h4>
                                <div class="row">
                                    <div class="col-md-3">
                                        <form action="#">
                                            <div class="form-group">
                                                <label for="monthyear">Periode:</label></br>
                                    ...
                                    <div class="col-md-9">
                                            <button type="button" class="btn mb-1 btn-primary">Penerimaan<span class="btn-icon-right"><i class="fa fa-money"></i></span>
                                            </button>
                                            <button type="button" class="btn mb-1 btn-info">Pengeluaran<span class="btn-icon-right"><i class="fa fa-shopping-cart"></i></span>
                                            </button>
                                            <button type="button" class="btn mb-1 btn-secondary">Transfer<span class="btn-icon-right"><i class="fa fa-send"></i></span>
                                            </button>
                                    </div>
                                </div>
                            </br>
                                    ...
                                    <table class="table table-bordered table-striped verticle-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span><a href="#" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted m-r-5"></i>&nbsp;&nbsp;&nbsp;&nbsp; </a><a href="#" data-toggle="tooltip" data-placement="top" title="Hapus"><i class="fa fa-close color-danger"></i></a></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Textiles</td>
